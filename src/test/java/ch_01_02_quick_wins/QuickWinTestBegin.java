...
public class QuickWinTestBegin {
/*
 ...
 */
    ...
    public void findInstructionsByIdOrName(){
        ...
        System.out.println(instructionsPara.getText());
        System.out.println(instructionsParaAgain.get(0).getText());
    }
    ...
    public void colors(){
        ...
        final Color myBlackvalue = new Color(0,0,0,1);
        Assertions.assertEquals(title.getCssValue("background-color"),myBlackvalue.asRgba());
